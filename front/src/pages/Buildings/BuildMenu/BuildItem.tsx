            ...
            <Tabs.Panel sx={{ flex: 1 }} value={el} key={id}>
                ...
                styles={(mantineTheme) => ({
                  scrollbar: {
                    ".mantine-ScrollArea-thumb": {
                      backgroundColor: mantineTheme.colors?.[theme]?.[3],
                      ":hover": {
                        backgroundColor: mantineTheme.colors?.[theme]?.[4],
                      },
                    },
                  },
                })}
              >
                <RessourcesArea
                  ...
                  ressources={
                    el === "cost" ? info.cost : ressourceItemParser(info[el])
                  }
                  valueParser={el === "cost" ? (value: number) => {
